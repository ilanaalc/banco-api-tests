...
describe ('Transferênciais', () => {
    ...
    describe ('GET /transferênciais/{id}', () => {
        it('Deve retornar sucesso com 200 e dados iguais ao registro de transferencia contido no banco de dados quando o ID for válido', async () => {
            ...
            expect(resposta.body.id).to.equal(15) //Valida conteudo do valor do id
            expect(resposta.body.id).to.be.a('number') //Valida tipagem do valor do id
    ...
    describe('GET /transferencias', () => {
        it('Deve retornar 10 elementos na paginacao quando informar limite de 10 registros', async () => {
            ...
            expect(resposta.body.transferencias).to.have.lengthOf(10) //contador de itens 
        })
    })
})